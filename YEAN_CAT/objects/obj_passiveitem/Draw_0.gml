...
draw_sprite_ext(sprite_index,image_index,x,y,(1/(sprite_get_height(sprite_index)/300))/2+(0.5 * sin(2 * pi * osc / 7) + 0.5)/5*1.2,(1/(sprite_get_height(sprite_index)/300))/2+(0.5 * sin(2 * pi * osc / 5) + 0.7)/5*1.2,0,c_blue,.9)

...
//if prevtarg!=other {
	if instance_exists(yeancat) {
		...
		other.col=c_red
		var ddd=master.lyricism*master.damage*(clamp(master.dondasblessing,1,1+999*round(1-(yeancat.healthh/yeancat.maxhealth))))*damage/fps_real
		...
		yeancat.healthh+=clamp(master.faith*(clamp(master.dondasblessing,1,1+999*round(1-(yeancat.healthh/yeancat.maxhealth))))*master.damage*damage*(1-other.resistance)*master.criticalamount/fps_real,0,99999999);
		}
		} else {

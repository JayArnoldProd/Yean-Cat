...
if (index1 >= 0 && index2 < arl) {
    ...
    enemy_height_fromground = obj_terrain.y+power(clamp(obj_terrain.playeraltitude+obj_terrain.player_height_fromground/2,0,99999),.85)-spaci*1+lerp(height1, height2, fract) - (y);

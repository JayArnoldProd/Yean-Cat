...
var countpoint=0
for (var i=0; i < array_length(master.characters); i++) {
countpoint+=(master.characters[i,2]-(master.characters[i,5]+master.characters[i,6]+master.characters[i,7]+master.characters[i,8]-3))
}
if countpoint>0 {
	ex=1
}

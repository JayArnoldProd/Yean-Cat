...
//if fade=1 or warning=1 {
//	exit
//}

//if scale/scaleto>.9 then {
//	hitdensity=1
//}
//if instance_exists(yeancat) and dead=0 and hitdensity=1{
//if other.invincible=0 {
...
//	if grabbed=0 and frozen = 0 {
//if random(1000)>(master.champion*1000) {
//var ddd = alph*(clamp(master.dondasblessing,1,1+999*round(1-(clamp(yeancat.healthh/yeancat.maxhealth,0,1)))))*damage*(1*(1-master.resistance))*(1-yeancat.oxyresistance)*(1-yeancat.stemresistance)
//other.healthh-=ddd

...
backup_directory "code_text" "code_backups/documentation_backup.txt" "*.md.txt"
backup_directory "code_text" "code_backups/config_backup.txt" "*.py.txt *.toml.txt *.txt"
backup_directory "code_text" "code_backups/metadata_backup.txt" "*.txt"

...
# Step 3: Run force_push.sh with an optional commit message argument
echo "Running force_push.sh..."
./GIT_GPT_SERVER/scripts/force_push.sh "${1:-Catch up with local changes}"

# Step 4: Run code_backup script with hierarchy generation
echo "Running backup script..."
./GIT_GPT_SERVER/scripts/code_backup.sh

# Step 5: Identify and kill specific Flask processes
echo "Checking for and killing existing Flask servers on ports 5000..."
./GIT_GPT_SERVER/scripts/stop_server.sh

# Step 6: Add and commit changes to GitHub (without push)
echo "Adding and committing code_backups to GitHub..."
git add .
git commit -m "Automated backup and deployment"
git push origin main --force

# Step 7: Check if the server is running and pull logs
